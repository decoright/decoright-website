                                    ...
                                    <div className="flex gap-2 w-full">
                                        <div className="flex flex-col gap-2 w-full">
                                            ...
                                            <div className="flex flex-wrap">
                                                <span className="text-2xs md:text-xs min-w-max after:content-['•'] after:mx-1 last:after:content-none">{service.is_active ? t('admin.services.status_active') : t('admin.services.status_inactive')}</span>
                                            </div>
